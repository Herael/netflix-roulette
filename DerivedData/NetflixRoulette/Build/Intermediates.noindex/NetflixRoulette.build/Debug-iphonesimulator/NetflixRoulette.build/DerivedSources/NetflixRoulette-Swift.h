...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NetflixRoulette",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15NetflixRoulette11AppDelegate")
...
SWIFT_CLASS("_TtC15NetflixRoulette24MovieSearchTableViewCell")
...
@interface SearchViewController (SWIFT_EXTENSION(NetflixRoulette)) <UITableViewDelegate>
@end


@interface SearchViewController (SWIFT_EXTENSION(NetflixRoulette)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end
...
SWIFT_CLASS("_TtC15NetflixRoulette31ShuffleResultListViewController")
@interface ShuffleResultListViewController : UIViewController
@property (nonatomic, strong) IBOutlet UITableView * _Null_unspecified mediaResultList;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface ShuffleResultListViewController (SWIFT_EXTENSION(NetflixRoulette)) <UITableViewDelegate>
@end


@interface ShuffleResultListViewController (SWIFT_EXTENSION(NetflixRoulette)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end
...
SWIFT_CLASS("_TtC15NetflixRoulette21ShuffleViewController")
@interface ShuffleViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified randomBox;
